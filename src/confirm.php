        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <select class="form-select <?php echo in_array("eiga", array_keys($errors)) ? "is-invalid" : "" ?>" name="eiga" id="eiga" value="<?php echo $_POST['eiga']; ?>">
              ...
              <option <?php if ($_POST["eiga"] === 'あ') echo " selected"; ?> value="あ">あ</option>
              <option <?php if ($_POST["eiga"] === 'い') echo " selected"; ?> value="い">い</option>
              <option <?php if ($_POST["eiga"] === 'う') echo " selected"; ?> value="う">う</option>
            </select>
          </div>
        </div>
        <div class="mb-3 row">
